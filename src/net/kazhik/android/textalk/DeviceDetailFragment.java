...
import net.kazhik.android.textalk.chat.FileTransferService;
...
public class DeviceDetailFragment extends Fragment implements
	...
	public void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		Log.d("DeviceDetailFragment", "Intent----------- " + uri);
	...
	public static class FileServerAsyncTask extends
		...
		protected String doInBackground(Void... params) {
			try {
				...
				Log.d("DeviceDetailFragment", "Server: Socket opened");
				Socket client = serverSocket.accept();
				Log.d("DeviceDetailFragment", "Server: connection done");
	...
	public static boolean copyFile(InputStream inputStream, OutputStream out) {
		...
		try {
			...
			Log.d("DeviceDetailFragment", e.toString());
			return false;
		}
		return true;
	}
